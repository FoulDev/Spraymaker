...
#ifndef SPRAYMAKERAPPLICATION_H
#define SPRAYMAKERAPPLICATION_H

#include <QApplication>

class SpraymakerApplication : public QApplication
{
    Q_OBJECT
public:
    SpraymakerApplication(int &argc, char **argv, int flags = ApplicationFlags);
    bool notify(QObject * receiver, QEvent * event) override;
};

#endif // SPRAYMAKERAPPLICATION_H
